...
<body>
    ...
    <div class="container">
        ...
        <a href="{{route ('tambahdokter')}}" class="btn btn-success btn-sm mb-3">Tambah Dokter Baru</a>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- Tombol Edit -->
                        <a href="{{route ('editdokter', $item->id)}}" class="btn btn-success btn-sm">Edit</a>

                        <!-- Tombol Hapus -->
                        <form action="{{route ('dokter.destroy', [ 'id' => $item->id])}}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
