...
<body>
    ...
    <div class="container">
        ...
        <a href="{{route ('tambahobat')}}" class="btn btn-success btn-sm mb-3">Tambah Obat Baru</a>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- Tombol Edit -->
                        <a href="{{route ('editobat', $item->id)}}" class="btn btn-success btn-sm">Edit</a>

                        <!-- Tombol Hapus -->
                        <form action="{{route ('obat.destroy', [ 'id' => $item->id])}}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
