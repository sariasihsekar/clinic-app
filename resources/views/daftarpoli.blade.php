...
<body>
    ...
    <div class="container">
        ...
        <a href="{{route ('tambahpoli')}}" class="btn btn-success btn-sm mb-3">Tambah Poli Baru</a>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- Tombol Edit -->
                        <a href="{{route ('editpoli', $item->id)}}" class="btn btn-success btn-sm">Edit</a>

                        <!-- Tombol Hapus -->
                        <form action="{{route ('poli.destroy', [ 'id' => $item->id])}}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
