    ...
    <div class="container">
        ...
        <form action="{{ route('dokter.update', $dokter->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id_poli" name="id_poli" value="{{ old('id_poli', $dokter->id_poli) }}" required>
            </div>

            <div class="mb-3">
                <label for="password" class="form-label">Password</label>
                <input type="text" class="form-control" id="password" name="password" value="{{ old('password', $dokter->password) }}" required>
            </div>

            <button type="submit" class="btn btn-primary">Update</button>
            <a href="{{ route('daftardokter') }}" class="btn btn-secondary">Kembali</a>
        </form>
    </div>
</body>
