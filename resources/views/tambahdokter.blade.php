...
<div class="container">
        ...
        <form action="{{route ('doktertambah')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="foto" class="form-label">ID Poli</label>
                <input type="text" class="form-control" id="id_poli" name="id_poli" value="{{ old('id_poli') }}" required>
                @error('id_poli')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
